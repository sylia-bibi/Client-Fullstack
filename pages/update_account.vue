    ...
    <div class="container mx-auto">
        <div class="max-w-md mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
            <div class="text-center">
                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Modifier mon compte</h1>
                <p class="text-gray-400 dark:text-gray-400">Remplissez le formulaire suivant afin de mettre à jour vos informations</p>
            </div>
            <div class="m-7">
                <form >
                    ...
                    <div class="mb-6">
                        <button @click.prevent="sendSub" class="w-full px-3 py-4 text-white bg-pink-500 rounded-md focus:bg-orange-600 focus:outline-none">Mettre à jour</button>
                    </div>
                     <div class="message__error" v-if="change == true"> 
                        <p>Vos informations ont bien été mises jour! </p>
  ...
  methods: {
    sendSub: function() {
      ...
      console.log(this.firstName, this.lastName, this.passWord, this.email, this.age );
               ...
               fetch(
                   `${process.env.API_URL}/updateUser/${jwtDecode.id}`,
                   {
                       method: "PUT",
                       headers:{
